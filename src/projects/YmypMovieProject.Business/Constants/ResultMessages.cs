...
namespace YmypMovieProject.Business.Constants;
public static class ResultMessages
{
    ...
    public static string SuccessCategoryListed = "Kategoriler başarıyla listelendi.";
    ...
    public static string ErrorCategoryListed = "Kategoriler listelenirken hata oluştu";
    public static string ErrorCategoryGetById = "Seçilen kategori bulunamadı.";
    ...
    public static string SuccessMovieListed = "Filmler başarıyla listelendi.";
    ...
    public static string ErrorMovieListed = "Filmler listelenirken hata oluştu";
    ...
    public static string SuccessUserRegister = "Kullanıcı başarıyla kaydedildi.";
    public static string ErrorPassword = "şifre hatalı";
    public static string SuccessLogin = "giriş başarılı.";
    public static string UserExist = "bu mail adresi zaten kayıtlı";
}